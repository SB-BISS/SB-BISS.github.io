...
describe('sign and verify', () => {
  ...
  it('signs/verifies a message by random key (keccak)', () => {
    ...
    expect((0, _verify.default)(MESSAGE, signature, address, {
      hashType: 'keccak'
    })).toBe(true);
  });
  ...
  it('works over a range of random keys (blake2)', () => {
    for (let i = 0; i < 256; i++) {
      ...
      try {
        expect((0, _verify.default)(MESSAGE, (0, _sign.default)(MESSAGE, pair, {
          hashType: 'blake2'
        }), (0, _hasher.default)('blake2', pair.publicKey), {
          hashType: 'blake2'
        })).toBe(true);
      } catch (error) {
  ...
  it('works over a range of random keys (keccak)', () => {
    for (let i = 0; i < 256; i++) {
      ...
      try {
        expect((0, _verify.default)(MESSAGE, (0, _sign.default)(MESSAGE, pair, {
          hashType: 'keccak'
        }), (0, _hasher.default)('keccak', pair.publicKey), {
          hashType: 'keccak'
        })).toBe(true);
      } catch (error) {
